...
const data = new SlashCommandBuilder()
    .setName('guncelleme')
    .setDescription("Karsli Guard Botu'nun yenilikleri gösterir.");
module.exports.execute = async (client, interaction, db) => {
    ...
    .setDescription(`> **Karsli Guard** V1 Güncellemesi
...
> 3) **davet** adında yeni bir komut geldi, bu komutun amacı sunucuda yönetici izni olmayan bir role yönetici izni verilirse bot otomatik olarak o rolü siler.
